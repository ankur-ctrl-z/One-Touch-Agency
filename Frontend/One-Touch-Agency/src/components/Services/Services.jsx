    ...
    <div className="text-gray-400 body-font bg-gray-900">
      <div className="container px-5 py-24 mx-auto -mt-10">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          <h1 className="sm:text-5xl text-2xl mt-4 font-medium title-font mb-2 text-white" style={{ fontFamily: 'Chivo, sans-serif' }}>
            Our Services
          </h1>
        </div>
        <div className="flex flex-wrap -m-4">
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="h-56 flex flex-col justify-center items-center">
              <p className="leading-relaxed text-opacity-80 text-4xl pt-4 text-center font-bold text-yellow-300" style={{ fontFamily: 'Adamina, serif' }}>
              ...
              <div 
                ...
                <button className="text-white text-[18px]" style={{ fontFamily: 'Adamina, serif' }}>
                  View All
                </button>
              </div>
            </div>
          ...
          {[
            ...
            >
              <div className={`border border-yellow-500 border-opacity-75 p-6 rounded-lg relative overflow-hidden ${clickedIndex === index ? 'h-96' : 'h-64'}`}>
                ...
                <h2 className={`text-2xl text-white font-medium title-font absolute bottom-0 left-0 mb-2 ml-4 transition-all duration-300 ${clickedIndex === index ? 'transform -translate-y-20' : ''}`} style={{ fontFamily: 'Adamina, serif' }}>
                  {service.title}
                </h2>
              </div>
            </div>
