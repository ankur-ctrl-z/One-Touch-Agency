    ...
    >
      <div className="container mx-auto flex flex-wrap py-1 flex-col md:flex-row items-center relative overflow-hidden">
        <div className="flex items-center">
          <img src={scrolled ? logo2 : logo1} alt="logo" className="w-28 h-24 ml-2 rounded-lg transition-all duration-300" />
        </div>
        ...
        <div className="flex items-center gap-1">
          <a href="https://www.instagram.com/onetouchagency_/" target="_blank" rel="noopener noreferrer" className={`social-link mx-2 ${scrolled ? 'text-white' : 'text-black'}`}>
            <FaInstagram className="text-3xl transition-colors duration-300 hover:text-pink-800" />
          </a>
          <a href="https://www.linkedin.com/company/one-touch-agency1/" target="_blank" rel="noopener noreferrer" className={`social-link mx-2 ${scrolled ? 'text-white' : 'text-black'}`}>
