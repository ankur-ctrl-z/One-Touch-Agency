        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4 -mt-48">
            ...
            <nav className="list-none mb-8 text-white text-2xl mt-8 space-y-2">
              ...
              <li>
                <a className="text-white hover:text-gray-800" href="#">About Us</a>
              </li>
              <li>
                <a className="text-white hover:text-gray-800" href="#">Services</a>
              </li>
              <li>
                <a className="text-white hover:text-gray-800" href="#">Portfolio</a>
              </li>
            </nav>
            ...
            <div className="flex flex-col items-center justify-center pd-10 -mt-64">
              <div className="relative w-40 sm:w-auto mb-4 ml-3">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className="w-80 sm:w-96 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
              <button className="flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded mr-64">
                Subscribe
              </button>
            </div>
          </div>
